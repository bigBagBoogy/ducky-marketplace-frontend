...
const Checkbox: React.FC<CheckboxProps> = ({ handleCheckboxChange, isChecked }) => {
  return (
    <>
    <div className="show-text ml-32 flex-shrink-0 w-72 fixed">
      {isChecked ? (
<h1 className="text-2xl font-bold mb-0 text-white text-stroke text-aqua-500">Show NFTs</h1>
      ) : (
        <h1 className="text-2xl font-bold mb-0 text-white">Show Perks</h1>
      )}
    </div>
