        ...
        <div className="grid grid-cols-3 gap-6">
          {nftData.map((nft) => (
            <div key={nft.id} className="bg-gray-800 p-6 rounded-md"> {/* This is the card*/}
              {isChecked ? (
                <p className="text-lg h-56 font-bold text-white mb-4">{nft.description}</p>
              ) : (
                <img
                  src={nft.imageUrl}
                  alt={nft.title}
